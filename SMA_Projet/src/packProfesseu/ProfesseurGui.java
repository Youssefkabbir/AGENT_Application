...
public class ProfesseurGui extends JFrame {
	...
	public ProfesseurGui(String title) throws HeadlessException {
		setTitle(title);
	...
	private Professeur CAgent;
	private JButton btnNewButton;
private TextArea textArea_1 ;
	public Professeur getCAgent() {
		return CAgent;
	}

	public void setCAgent(Professeur cAgent) {
		CAgent = cAgent;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProfesseurGui frame = new ProfesseurGui();
	...
	public ProfesseurGui() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				params.put("agentProfesseur", agentName);
		...
		/*
		 * DA=new DeployerAgent(); String titre=DA.E;
		 */
